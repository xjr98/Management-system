        ...
        <!-- 表格:展示平台属性 -->
         <el-table :data="attrList" style="width: 100%" border>
          ...
          <el-table-column prop="prop" label="属性值列表" width="width">
            <!-- slot是插槽，slot-scope=""语义更加明确，相当于一行的数据 -->
            <template slot-scope="{row,$index}">
              <el-tag type="success" v-for="(attrValue,index) in row.attrValueList" :key="attrValue.id" style="margin: 0px 20px">
                {{attrValue.valueName}}
              </el-tag>
            </template>
          </el-table-column>
...
<script>
  ...
  export default{
    ...
    methods: {
      ...
      addAttrValue() {
        //向属性值的数组里面添加元素
        //attrId：是相应的属性的id，目前是添加属性的操作，还没有相应的属性的id，目前而言带给服务器的id为undefined
        //valueName:相应的属性值的名称
      ...
      addAttr() {
        ...
        this.attrInfo = {
          ...
          categoryId: this.category3Id, //重点：三级分类的id
      ...
      //气泡确认框确定按钮的回调
      //注：目前模板中的版本号2.13.x  是@onConfirm 不是最新版本的@confirm
